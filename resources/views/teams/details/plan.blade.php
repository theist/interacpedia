<div class="row full">
    <div class="main">
        <div class="content col-md-12">
            ...
            <div class="row">
                <div class="col-md-8">Aquí se deben diligenciar los datos correspondientes al plan del proyecto. <br></div>
                <div class="col-md-4 panel panel-info">
                    ...
                    <div class="panel-body">También puedes tener este formato en un documento en word si lo necesitas
                        ...
                        <a target="_blank"
                            href="/docs/plan/Formato-PlanProyecto-Interacpedia-V1.docx">Formato-PlanProyecto-Interacpedia-V1.docx</a></div>
                </div>
            </div>
            <hr>
            <div class="row">
