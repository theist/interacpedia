...
return array(
    ...
    'properties' => array(
        'creator'        => 'Interacpedia',
        'lastModifiedBy' => 'Interacpedia',
        'title'          => 'Reporte',
        'description'    => 'Reporte en excel de Interacpedia',
        'subject'        => 'Exportable en Excel',
        'keywords'       => 'interacpedia, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Interacpedia',
        'company'        => 'Idea Minds Group SAS',
    ),
